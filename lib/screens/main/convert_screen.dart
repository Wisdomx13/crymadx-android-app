...
/// Convert Screen - Bybit-style crypto conversion with real balance validation
...
class _ConvertScreenState extends State<ConvertScreen> {
  ...
  // Conversion history - stored locally, starts empty
  ...
  void _setMaxAmount() {
    if (_availableBalance > 0) {
      _fromAmountController.text = _availableBalance.toStringAsFixed(
        _fromCrypto == 'USDT' || _fromCrypto == 'USDC' ? 2 : 8
      );
      _calculateToAmount();
    }
  }
    ...
    if (mounted) {
      ...
      setState(() {
        _conversionHistory.insert(0, {
          'from': '${fromAmount.toStringAsFixed(fromAmount < 1 ? 8 : 2)} $_fromCrypto',
          'to': '${toAmount.toStringAsFixed(8)} $_toCrypto',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    _loadAvailableBalance(); // Refresh balance
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.tradingBuy,
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isLoading
                      ...
                      : const Text('Quote', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      _availableBalance.toStringAsFixed(_availableBalance < 1 ? 8 : 2),
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            hintText: '0.00',
                            hintStyle: TextStyle(color: isDark ? Colors.grey[700] : Colors.grey[400], fontSize: 18),
          ...
          Row(
            children: [
              ...
              Text(
                ...
                style: TextStyle(color: AppColors.tradingBuy, fontSize: 20, fontWeight: FontWeight.w600),
              ),
            ],
          ),
        ],
            ...
            children: [
              ...
              ...(_cryptoOptions.map((crypto) => ListTile(
                ...
                onTap: () {
                  ...
                  _loadPrices();
                  if (isFrom) _loadAvailableBalance();
                },
              ))),
              SizedBox(height: MediaQuery.of(context).padding.bottom),
            ],
